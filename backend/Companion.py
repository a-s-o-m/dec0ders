class Companion:
    ...
    def calculate_match(pref_age, pref_height, pref_personality, pref_pet, pref_gender):
        ...
        if pref_personality == self.pref_personality:
            pref_matches += 1

        if pref_pet == self.pref_pet:
            pref_matches += 1

        if pref_gender == self.pref_gender:
            pref_matches += 1
